...
This project is about a **restaurant menu optimasiation system** data pipeline planing and execution in AWS system. This project contains is built on the idea of the historical sales data and extra information provided by an API can help the restaurant ownes in creating a more crowd pleasing menu for the restaurant. 
By building the data pipeline and runing queries on the enriched data the owners will have the proper information to make their business from good to great.
## The stakehoalders 
